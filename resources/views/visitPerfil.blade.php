            ...
            <div class="col-8 d-flex justify-content-around">
                ...
                <div>
                    <div class="btn-group dropdown" role="group">
                        <button type="button" class="btn fw-bolder" data-bs-toggle="dropdown" aria-expanded="false" style="background-color: #eb4e3d">
                            {{ auth()->user()->nickname }}
                        </button>
    ...
    <div class="row">
        <div class="col-3" style="background-color: #f6f9fa">
            <div class="my-3  fw-bolder">
                <div class="d-flex justify-content-center"><img src="{{ asset(auth()->user()->foto) }}" alt="Foto Perfil" width="200" height="200" style="border-radius: 50%"></div>
                <div class="d-flex justify-content-center">
                    <h5 class="card-title fw-bolder">{{ '@' . auth()->user()->nickname }}</h5>
                </div>
                <ul class="text-left">
                    <li class="list-group-item">cantidad de recetas: {{ $cantidadRecetas }}</li>
            ...
            <div class="modal-content" style="background-color: #f6f9fa">
                ...
                <div class="modal-body">
                    <form method="POST" action="visper" enctype="multipart/form-data" id="miFormularioId">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" class="form-control" id="nomb" placeholder="Cómo se llama tu receta?">
                        </div>
                        <div class="mb-3">
                ...
                <div class="modal-footer">
                    <div>
                        ...
                        <button type="submit" class="btn fw-bolder" id="btnPublicarReceta" style="background-color: #eb4e3d" onclick="guardar()">Publicar Receta</button>
                    </div>
                </div>
            </div>
        </div>
