...
<body class="container-fluid" style="background-color: #c0dd8d;">
  <div class="row">
    ...
    <div class="row">
      <div class="col-10 d-flex justify-content-end">
        <div class="col-10 d-flex justify-content-center align-items-center my-1" style="background: white; border-radius: 30px 30px 30px 30px;">

          <form>
            <div class="mb-3">
              <label for="contraseñaActual" class="form-label">Contraseña Actual</label>
              <input type="text" class="form-control" id="contraseñaActual">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="txtCpassword">
            </div>
            <div class="row mt-3">
